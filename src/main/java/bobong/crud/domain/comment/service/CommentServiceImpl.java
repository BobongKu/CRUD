...
public class CommentServiceImpl implements CommentService{
    ...
    public Comment findById(Long id) throws Exception {
        return commentRepository.findById(id).orElseThrow(() -> new Exception("댓글이 존재하지 않습니다."));
    }
    ...
    public void remove(Long id) throws Exception {
        Comment comment = commentRepository.findById(id).orElseThrow(() -> new Exception("댓글이 존재하지 않습니다."));
